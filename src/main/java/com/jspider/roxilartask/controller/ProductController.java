package com.jspider.roxilartask.controller;
...
import com.jspider.roxilartask.repo.ProductRepo;
...
public class ProductController {
	...
	public List<Product> fetchProducts (@PathVariable String search) {
		try {
			return productRepo.fetchProductsByPrice(Double.parseDouble(search));
		}catch (Exception e) {
